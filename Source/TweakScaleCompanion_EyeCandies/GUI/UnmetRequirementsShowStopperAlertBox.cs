...
namespace TweakScaleCompanion.EyeCandies.GUI
{
...
If you decide to proceed, do it with caution - use S.A.V.E. just in case.";
		...
		private static readonly string AMSG = @"go to TweakScale Companion Program's page, look for the dependencies for Eye Candies, download and install {0} and restart KSP (it will close now)";
